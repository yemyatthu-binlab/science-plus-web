  ...
  return (
    <div className="mx-5 pb-5">
      ...
      <ThemeText className="mt-2 mb-5">
        ...
        <br />
        <br />
        ဥပမာ - သင်ရှာလိုက်တဲ့ file name ဟာ cat ဆိုပါစို့။ computer ဟာ file 50000
        ...
        စုစုပေါင်းရယ် ထဲကပဲ search လုပ်မှာမျိုးဖြစ်ပါတယ်။ (ဒါဟာ ဥပမာပဲ ဖြစ်ပြီး
        ...
        သင် search bar ကနေ ရှာလိုက်တဲ့ အချိန်မှာတော့ အမြန်ဆုံး တွေ့အောင် searched
        keyword နဲ့စတဲ့ file တွေထဲက အရင်ရှာတာမျိုး၊ အဲ့တာမတွေ့မှ searched keyword
        ထဲမှာ အစဉ်လိုက်ဖြစ်နေတဲ့အတိုင်း ပါတဲ့ file တွေကိုရှာ တာမျိုး
        လုပ်မှာဖြစ်ပါတယ်။
        <br />
        <br />
        <br />
        ...
        အပေါ်က ဥပမာလို ဘယ်လိုအရင်ရှာမယ်၊ ဘယ်လိုမှမတွေ့မှ ဘယ်လိုထပ်ရှာမယ်ဆိုတဲ့
        နည်းလမ်းတွေကို algorithm လို့ခေါ်တာလို့ အလွယ်မှတ်ယူနိုင်ပါတယ်။ အသေးစိတ်ကို
